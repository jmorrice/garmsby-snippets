...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ReadyNotification'
        db.create_table(u'designs_readynotification', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['auth.User'])),
            ('design', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['designs.Design'])),
        ))
        db.send_create_signal(u'designs', ['ReadyNotification'])

        # Adding field 'Design.produced'
        db.add_column(u'designs_design', 'produced',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'ReadyNotification'
        db.delete_table(u'designs_readynotification')

        # Deleting field 'Design.produced'
        db.delete_column(u'designs_design', 'produced')
    ...
    models = {
        ...
        u'designs.design': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 9, 25, 0, 0)', 'auto_now_add': 'True', 'blank': 'True'}),
            ...
            'produced': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
        ...
        u'designs.like': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 9, 25, 0, 0)', 'auto_now': 'True', 'blank': 'True'}),
