...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'designs_design', (
            ...
            ('name', self.gf('django.db.models.fields.CharField')(default='DefaultDesign', max_length=50)),
            ('story', self.gf('django.db.models.fields.TextField')(default='Default Story', max_length=250)),
            ('likes', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('full_img', self.gf('django.db.models.fields.files.ImageField')(default='designs/default_design.png', max_length=100)),
        ))
        db.send_create_signal(u'designs', ['Design'])

        # Adding model 'Like'
        db.create_table(u'designs_like', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ...
        db.send_create_signal(u'designs', ['Like'])
    ...
    def backwards(self, orm):
        ...
        # Deleting model 'Like'
        db.delete_table(u'designs_like')
    ...
    models = {
        ...
        u'designs.design': {
            ...
            'full_img': ('django.db.models.fields.files.ImageField', [], {'default': "'designs/default_design.png'", 'max_length': '100'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
