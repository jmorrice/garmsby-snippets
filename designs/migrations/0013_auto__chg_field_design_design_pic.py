...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Design.design_pic'
        db.alter_column(u'designs_design', 'design_pic', self.gf('sorl.thumbnail.fields.ImageField')(max_length=100))

    def backwards(self, orm):

        # Changing field 'Design.design_pic'
        db.alter_column(u'designs_design', 'design_pic', self.gf('s3direct.fields.S3DirectField')())
    ...
    models = {
        ...
        u'designs.design': {
            ...
            'design_pic': ('sorl.thumbnail.fields.ImageField', [], {'max_length': '100'}),
            ...
            'tee_pic': ('sorl.thumbnail.fields.ImageField', [], {'max_length': '100'}),
