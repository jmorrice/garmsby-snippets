...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Design.garment'
        db.add_column(u'designs_design', 'garment',
                      self.gf('django.db.models.fields.CharField')(default='T-Shirt', max_length=50),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Design.garment'
        db.delete_column(u'designs_design', 'garment')
    ...
    models = {
        ...
        u'designs.design': {
            ...
            'garment': ('django.db.models.fields.CharField', [], {'default': "'T-Shirt'", 'max_length': '50'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
