...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Design.product'
        db.add_column(u'designs_design', 'product',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['catalogue.Product'], null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Design.product'
        db.delete_column(u'designs_design', 'product_id')
