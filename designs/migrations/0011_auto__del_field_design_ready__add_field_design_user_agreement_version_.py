...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Design.ready'
        db.delete_column(u'designs_design', 'ready')

        # Adding field 'Design.user_agreement_version'
        db.add_column(u'designs_design', 'user_agreement_version',
                      self.gf('django.db.models.fields.CharField')(default='v1.0', max_length=10),
                      keep_default=False)

        # Adding field 'Design.user_agreement_accepted'
        db.add_column(u'designs_design', 'user_agreement_accepted',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Design.ready'
        db.add_column(u'designs_design', 'ready',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Deleting field 'Design.user_agreement_version'
        db.delete_column(u'designs_design', 'user_agreement_version')

        # Deleting field 'Design.user_agreement_accepted'
        db.delete_column(u'designs_design', 'user_agreement_accepted')
    ...
    models = {
        ...
        u'designs.design': {
            ...
            'url': ('django.db.models.fields.CharField', [], {'default': "'default_design'", 'max_length': '50'}),
