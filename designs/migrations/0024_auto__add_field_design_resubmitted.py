...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Design.resubmitted'
        db.add_column(u'designs_design', 'resubmitted',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Design.resubmitted'
        db.delete_column(u'designs_design', 'resubmitted')
    ...
    models = {
        ...
        u'designs.design': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 11, 15, 0, 0)', 'auto_now_add': 'True', 'blank': 'True'}),
        ...
        u'designs.like': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 11, 15, 0, 0)', 'auto_now': 'True', 'blank': 'True'}),
