...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Design.price'
        db.alter_column(u'designs_design', 'price', self.gf('django.db.models.fields.IntegerField')())

    def backwards(self, orm):

        # Changing field 'Design.price'
        db.alter_column(u'designs_design', 'price', self.gf('django.db.models.fields.FloatField')())
