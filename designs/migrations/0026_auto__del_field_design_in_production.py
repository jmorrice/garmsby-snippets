...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Design.in_production'
        db.delete_column(u'designs_design', 'in_production')


    def backwards(self, orm):
        # Adding field 'Design.in_production'
        db.add_column(u'designs_design', 'in_production',
    ...
    models = {
        ...
        u'designs.design': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 4, 29, 0, 0)', 'auto_now_add': 'True', 'blank': 'True'}),
        ...
        u'designs.like': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 4, 29, 0, 0)', 'auto_now': 'True', 'blank': 'True'}),
