...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Design.full_img'
        db.alter_column(u'designs_design', 'full_img', self.gf('django.db.models.fields.files.ImageField')(max_length=100))

    def backwards(self, orm):

        # Changing field 'Design.full_img'
        db.alter_column(u'designs_design', 'full_img', self.gf('topnotchdev.files_widget.fields.ImageField')(max_length=200))
