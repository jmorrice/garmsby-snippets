...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Design.url'
        db.add_column(u'designs_design', 'url',
                      self.gf('django.db.models.fields.CharField')(default='default_design', max_length=50),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Design.url'
        db.delete_column(u'designs_design', 'url')
