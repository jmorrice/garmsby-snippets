...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Design.tee_pic'
        db.alter_column(u'designs_design', 'tee_pic', self.gf('django.db.models.fields.URLField')(max_length=200))

    def backwards(self, orm):

        # Changing field 'Design.tee_pic'
        db.alter_column(u'designs_design', 'tee_pic', self.gf('sorl.thumbnail.fields.ImageField')(max_length=100))
