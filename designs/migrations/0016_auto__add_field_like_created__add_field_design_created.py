...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Like.created'
        db.add_column(u'designs_like', 'created',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, auto_now=True, blank=True),
                      keep_default=False)

        # Adding field 'Design.created'
        db.add_column(u'designs_design', 'created',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, auto_now=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Like.created'
        db.delete_column(u'designs_like', 'created')

        # Deleting field 'Design.created'
        db.delete_column(u'designs_design', 'created')
