...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Design.price'
        db.add_column(u'designs_design', 'price',
                      self.gf('django.db.models.fields.FloatField')(default=15.0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Design.price'
        db.delete_column(u'designs_design', 'price')
    ...
    models = {
        ...
        u'designs.design': {
            ...
            'price': ('django.db.models.fields.FloatField', [], {'default': '15.0'}),
