...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Design.in_voting'
        db.delete_column(u'designs_design', 'in_voting')

        # Deleting field 'Design.past_voting'
        db.delete_column(u'designs_design', 'past_voting')


    def backwards(self, orm):
        # Adding field 'Design.in_voting'
        db.add_column(u'designs_design', 'in_voting',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Design.past_voting'
        db.add_column(u'designs_design', 'past_voting',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)
    ...
    models = {
        ...
        u'designs.design': {
            ...
            'resubmitted': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
        ...
        u'designs.like': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 4, 28, 0, 0)', 'auto_now': 'True', 'blank': 'True'}),
