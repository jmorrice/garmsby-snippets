...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'UserProfile.size'
        db.alter_column(u'profiles_userprofile', 'size', self.gf('django.db.models.fields.CharField')(max_length=2, null=True))

    def backwards(self, orm):

        # Changing field 'UserProfile.size'
        db.alter_column(u'profiles_userprofile', 'size', self.gf('django.db.models.fields.CharField')(max_length=1, null=True))
    ...
    models = {
        ...
        u'profiles.userprofile': {
            ...
            'email_key': ('django.db.models.fields.CharField', [], {'default': "'28e6ad22-59ad-4b11-9e12-4c3d1b952873'", 'max_length': '36'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'joined': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 9, 27, 0, 0)', 'auto_now_add': 'True', 'blank': 'True'}),
            'location': ('django.db.models.fields.CharField', [], {'default': "'Not specified'", 'max_length': '100'}),
            'size': ('django.db.models.fields.CharField', [], {'max_length': '2', 'null': 'True'}),
