...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'profiles_userprofile', 'test_field',
    ...
    def backwards(self, orm):
        ...
        db.delete_column(u'profiles_userprofile', 'test_field')
    ...
    models = {
        ...
        u'profiles.userprofile': {
            ...
            'email_key': ('django.db.models.fields.CharField', [], {'default': "'ca074ab9-802e-4cf3-b4d9-281dbb341ff3'", 'max_length': '36'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            ...
            'test_field': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
