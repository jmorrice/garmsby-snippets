...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'profiles_userprofile', 'avatar', self.gf('django.db.models.fields.URLField')(max_length=200))

    def backwards(self, orm):

        # Changing field 'UserProfile.avatar'
        db.alter_column(u'profiles_userprofile', 'avatar', self.gf('sorl.thumbnail.fields.ImageField')(max_length=100))
    ...
    models = {
        ...
        u'profiles.userprofile': {
            ...
            'email_key': ('django.db.models.fields.CharField', [], {'default': "'1a42c2b8-6624-4ff1-86e9-be35f20fc3ed'", 'max_length': '36'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'joined': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 9, 4, 0, 0)', 'auto_now_add': 'True', 'blank': 'True'}),
