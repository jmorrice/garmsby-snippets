...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'profiles_userprofile', 'email_confirmed',
    ...
    def backwards(self, orm):
        ...
        db.delete_column(u'profiles_userprofile', 'email_confirmed')
    ...
    models = {
        ...
        u'profiles.userprofile': {
            ...
            'email_key': ('django.db.models.fields.CharField', [], {'default': "'576c5b63-76a4-4df4-afd3-86733a539b58'", 'max_length': '36'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
